...
```
java -Dspring.profiles.active=production -jar ./target/echo-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=com.sijareca.restgateway/echo
```
